...
Animation.prototype.init = function (obj, box) {
    ...
    this.cleanSpeed = 5;//obj.cleanSpeed;
...
Animation.prototype.appendText = function(callback) {
    ...
    this.txt.forEach(function(line, i) {
        self.box.printChar(i, 0, line.join(""));
    });
